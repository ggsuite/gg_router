...
abstract class AppLocalizations {
  ...
  /// No description provided for @navigateToIndexPage.
  ///
  /// In en, this message translates to:
  /// **'Navigate to index page'**
  String get navigateToIndexPage;

  /// No description provided for @navigateToPlacesPage.
  ///
  /// In en, this message translates to:
  /// **'Navigate to Places Page'**
  String get navigateToPlacesPage;

  /// No description provided for @navigateToSportsPage.
  ///
  /// In en, this message translates to:
  /// **'Navigate to Sports Page'**
  String get navigateToSportsPage;

  /// No description provided for @navigateToTransportationPage.
  ///
  /// In en, this message translates to:
  /// **'Navigate to Transportation Page'**
  String get navigateToTransportationPage;
